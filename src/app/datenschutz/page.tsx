      ...
      <main className="pt-32 pb-20 bg-white">
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          ...
          <div className="prose prose-gray max-w-none text-gray-600 leading-relaxed space-y-8">
            <section>
              <h2 className="text-xl font-bold text-brand-dark mt-10 mb-4">
...
Telefon: 030 1210 8372
              ...
              <p>
                ...
                zur Analyse Ihres Nutzerverhaltens verwendet werden. Sofern Sie
                über das Kontaktformular oder den Funnel eine Anfrage stellen,
                werden Ihre Angaben zur Bearbeitung Ihrer Anfrage und für den
...
Telefon: 030 1210 8372
              ...
              <p>
                ...
                Aufsichtsbehörde in datenschutzrechtlichen Fragen ist die
            ...
            <section>
              ...
              <h3 className="text-lg font-semibold text-brand-dark mt-6 mb-2">
                Kontaktformular / Funnel
              </h3>
              <p>
                Wenn Sie uns per Kontaktformular oder über unseren Funnel
              ...
              <p>
                ...
                Art.&nbsp;6 Abs.&nbsp;1 lit.&nbsp;b DSGVO, sofern Ihre Anfrage
                mit der Erfüllung eines Vertrags zusammenhängt oder zur
            ...
            <section>
              ...
              <p>
                ...
                Tracking-Dienste eingesetzt. Sollte sich dies ändern, wird diese
